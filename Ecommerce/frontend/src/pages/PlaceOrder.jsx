...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm: pt-14min-h-[80vh] border-t'>
      ...
      <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Email Address'></input>
      <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Street Address '></input>
      <div className='flex gap-3'>
...
<p className='text-gray-400 tex-sm font-medium mx-4'>CASH ON DELIVERY</p>            </div>
          </div>
        </div>
        <div className='w-full text-end mt-8'>
<button onClick = {()=>navigate('/orders')} className='bg-black text-white px-16 py-3 text-xl'>PLACE ORDER</button>
        </div>
        </div>
    </div>
  )
